    ...
    <main className="min-h-screen">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-8 prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4">3. Shipper Responsibilities</h2>
          <p className="text-muted-foreground mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4">4. Carrier Responsibilities</h2>
          <p className="text-muted-foreground mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4">5. Liability Limitations</h2>
          <p className="text-muted-foreground mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4">7. Claims Process</h2>
          <p className="text-muted-foreground mb-6 leading-relaxed">
